...
def init_logger(config):
    ...
    """
    # Allow experiment runners to isolate logs per run and avoid collisions in
    # the shared working-directory log folder.
    LOGROOT = os.environ.get('MMREC_LOG_DIR', './log/')
